...
return [
    ...
    */
    ...
    |
    */
    'entity' => Railken\LaraOre\EmailSender\EmailSender::class,
    ...
    |
    */
    'manager' => Railken\LaraOre\EmailSender\EmailSenderManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\EmailSender\EmailSenderRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\EmailSender\EmailSenderSerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\EmailSender\EmailSenderValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\EmailSender\EmailSenderAuthorizer::class,
    ...
    */
    'http' => [
        'admin' => [
            'enabled'    => true,
            'controller' => Railken\LaraOre\Http\Controllers\Admin\EmailSendersController::class,
            'router'     => [
                'prefix'      => '/admin/email-senders',
            ],
        ],
    ],
];
